...
@section('content')
    ...
    <section>
                ...
                <div class="boxstep boxstep1">
                    ...
                    <table class="tbstep1">
                        <tr>
                            ...
                            <td><input class="w60per" type="text" value="" name="name" id="assessor_name" size="" tabindex="" accesskey="" placeholder="阿部　薫" ></td>
                        </tr>
                        <tr>
                            <th><span class="hinsu">必須</span> 郵便番号</th>
                            <td><input  class="w60per" type="text" value="<?php if (isset($transfer_data_list['step1']['zip_code'])) echo $transfer_data_list['step1']['zip_code']; ?>" name="zip_code" id="zip_code_id" size="" tabindex="" onblur="AjaxZip3.zip2addr(this, &#039;&#039;, &#039;area&#039;, &#039;address&#039;);" accesskey="" placeholder="例）112-2222"></td>
                        </tr>
                        <tr>
                            <th><span class="hinsu">必須</span> 都道府県</th>
                            <td>
                                <select  name="area" id="area_id" class="w60per">
                        ...
                        <tr>
                            ...
                            <td><input  type="text" name="address" id="address" size="address" tabindex="" accesskey="" placeholder=""></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input  class="w60per" type="text" value="" name="phone" id="phone" size="" tabindex="" accesskey="" placeholder="0333334444"></td>
                        </tr>
                        <tr>
                            <th><span class="hinsu">必須</span> メール</th>
                            <td><input  class="w60per" type="text" value="" name="email" id="email" size="" tabindex="" accesskey="" placeholder="例）yamada@smart.com"></td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="boxstep">
                    ...
                    <table class="tbstep2">
                        <tr>
                            ...
                            <td>
                                <p class="flexrowbetween">
                                    <input  style="display: block" type="file" id="camera" data_name="pre" name="image_car" class="camera" accept="image/*" capture="camera"/>
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="flexrowbetween">
                                    <input  style="display: block" type="file" id="camera1" data_name="pre1" name="image_car1" class="camera" accept="image/*" capture="camera"/>
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="flexrowbetween">
                                    <input  style="display: block" type="file" id="camera2" data_name="pre2" name="image_car2" class="camera" accept="image/*" capture="camera" />
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="flexrowbetween">
                                    <input  style="display: block" type="file" id="camera3" data_name="pre3" name="image_car3" class="camera" accept="image/*" capture="camera"/>
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="flexrowbetween">
                                    <input  style="display: block" type="file" id="camera4" data_name="pre4" name="image_car4" class="camera" accept="image/*" capture="camera" />
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="flexrowbetween">
                                    <input  style="display: block" type="file" id="camera5" data_name="pre5" name="image_car5" class="camera" accept="image/*" capture="camera" />
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="flexrowbetween">
                                    <input  style="display: block" type="file" id="camera6" data_name="pre6" name="image_car6" class="camera" accept="image/*" capture="camera" />
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="flexrowbetween">
                                    <input  style="display: block" type="file" id="camera7" data_name="pre7" name="image_car7" class="camera" accept="image/*" capture="camera" />
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="flexrowbetween">
                                    <input style="display: block" type="file" id="camera8" data_name="pre8" name="image_car8" class="camera" accept="image/*" capture="camera" />
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="flexrowbetween">
                                    <input  style="display: block"  type="file" id="camera9" data_name="pre9" name="image_car9" class="camera" accept="image/*" capture="camera" />
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="flexrowbetween">
                                    <input style="display: block" type="file" id="camera10" data_name="pre10" name="image_car10" class="camera" accept="image/*" capture="camera" />
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="flexrowbetween">
                                    <input  style="display: block"  type="file" id="camera11" data_name="pre11" name="image_car11" class="camera" accept="image/*" capture="camera" />
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="flexrowbetween">
                                    <input style="display: block" type="file" id="camera12" data_name="pre12" name="image_car12" class="camera" accept="image/*" capture="camera" />
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="flexrowbetween">
                                    <input style="display: block" type="file" id="camera13" data_name="pre13" name="image_car13" class="camera" accept="image/*" capture="camera" />
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="flexrowbetween">
                                    <input style="display: block" type="file" id="camera14" data_name="pre14" name="image_car14" class="camera" accept="image/*" capture="camera" />
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="flexrowbetween">
                                    <input style="display: block" type="file" id="camera15" data_name="pre15" name="image_car15" class="camera" accept="image/*" capture="camera" />
                ...
                <div class="boxstep">
                    ...
                    <table class="tbstep2">
                        <tr>
                            ...
                            <td>
                                <p class="flexrowbetween">
                                    <input  style="display: block" type="file" id="camera16" data_name="pre16" class="verify_image" name="verify_image" accept="image/*" capture="camera" />
                ...
                <div class="boxstep">
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <input type="hidden" id="infor_car_name">
                                <select  name="maker" id="infor_maker_id" class="w60per">
                                    <option value="">----------</option>
                        ...
                        <tr>
                            ...
                            <td>
                                <select  name="model_name" id="infor_car_id" class="w60per">
                                    <option value="">----------</option>
                        ...
                        <tr>
                            ...
                            <td><input  class="w60per" type="text" value="" name="grade" id="grade" size="" tabindex="" accesskey="" placeholder=""></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input  class="w60per" type="text" value="" name="displacement" id="displacement" maxlength="20" size="" tabindex="" accesskey="" placeholder=""> cc</td>
                        </tr>
                        <tr>
                            <th><span class="hinsu">必須</span> 車台番号</th>
                            <td><input  class="w60per" type="text" value="" name="chassis_number" id="chassis_number" maxlength="30" size="" tabindex="" accesskey="" placeholder=""></td>
                        </tr>
                        <tr>
                            <th><span class="hinsu">必須</span> 走行状態備考</th>
                            <td><textarea  type="text" value="" name="driving_remark" id="driving_remark" size="" tabindex="" accesskey=""></textarea></td>
                        </tr>
                        <tr>
                            <th><span class="hinsu">必須</span> 喫煙状況</th>
                            <td>
                                <p class="radio">
                                    <label><input type="radio" value="0" id="info_smoking_status1" name="smoking" tabindex="" accesskey="" checked><span>有</span></label>
                                    <label><input type="radio" value="1" id="info_smoking_status2" name="smoking" tabindex="" accesskey=""><span>無</span></label>
                                    <label><input type="radio" value="2" id="info_smoking_status3" name="smoking" tabindex="" accesskey=""><span>不明</span></label>
                                </p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <select  name="drive_system" id="drive_system" class="w60per">
                        ...
                        <tr>
                            ...
                            <td><input  class="w60per" type="text" value="" name="engine_model" id="engine_model" size="" maxlength="10" tabindex="" accesskey="" placeholder=""></td>
                        </tr>
                        <tr>
                            <th><span class="hinsu">必須</span> 型式指定番号</th>
                            <td><input  class="w60per" type="text" value="" name="infor_model_number" id="infor_model_number" size="" tabindex="" accesskey="" placeholder=""></td>
                        </tr>
                        <tr>
                            <th><span class="hinsu">必須</span> 累計区分番号</th>
                            <td><input  class="w60per" type="text" value="" name="classification_number" id="classification_number" size="" tabindex="" accesskey="" placeholder=""></td>
                        </tr>
                        <tr>
                            <th><span class="hinsu">必須</span> <span>トランスミッション</span></th>
                            <td>
                                <select  name="transmission" id="transmission" class="w60per">
                        ...
                        <tr>
                            ...
                            <td>
                                <select  name="handle" id="handle" class="w60per">
                        ...
                        <tr>
                            ...
                            <td><input  class="w60per" type="text" value="" name="infor_number_passenger" id="infor_number_passenger" size="" tabindex="" accesskey="" placeholder=""></td>
                            {{--<select name="infor_number_passenger" id="" class="w60per">--}}
                        ...
                        <tr>
                            ...
                            <td>
                                <select  name="fuel" id="fuel" class="w60per">
                                    <option value="1">ガソリン</option>
                                    <option value="2">ディーゼル </option>
                                    <option value="3">ハイブリッド</option>
                                    <option value="4">電気自動車</option>
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="radio"><label><input type="radio" value="" id="infor_accident_repair1" name="infor_accident_repair" tabindex="" accesskey="" checked><span>有</span></label>
                                    <label><input type="radio" value="" id="infor_accident_repair2" name="infor_accident_repair" tabindex="" accesskey=""><span>無</span></label>
                                    <label><input type="radio" value="" id="infor_accident_repair3" name="infor_accident_repair" tabindex="" accesskey=""><span>不明</span></label></p>
                            </td>
                        </tr>
                        <tr>
                            <th><span class="hinsu">必須</span> 車両番号</th>
                            <td><input  class="w60per" type="text" value="" name="infor_vehicle_number" maxlength="20" id="infor_vehicle_number" size="" tabindex="" accesskey="" placeholder=""></td>
                        </tr>
                        <tr>
                            <th><span class="hinsu">必須</span> リサイクル料金</th>
                            <td><input  class="w60per" type="text" value="" name="recycling_fee" id="recycling_fee"  maxlength="10" size="" tabindex="" accesskey="" placeholder=""> 円</td>
                        </tr>
                        <tr>
                            <th><span class="hinsu">必須</span> 保証書</th>
                            <td>
                                <p class="radio"><label><input type="radio" value="1" id="infor_written_guarantee1" name="infor_written_guarantee" tabindex="" accesskey="" checked><span>有</span></label>
                                    <label><input type="radio" value="2" id="infor_written_guarantee2" name="infor_written_guarantee" tabindex="" accesskey=""><span>無</span></label>
                                    <label><input type="radio" value="3" id="infor_written_guarantee3" name="infor_written_guarantee" tabindex="" accesskey=""><span>未確認</span></label></p>
                            </td>
                        </tr>
                        <tr>
                            <th><span class="hinsu">必須</span> 点検記録簿</th>
                            <td>
                                <p class="radio"><label><input type="radio" value="1" id="infor_record_book1" name="infor_record_book" tabindex="" accesskey="" checked><span>有</span></label>
                                    <label><input type="radio" value="2" id="infor_record_book2" name="infor_record_book" tabindex="" accesskey=""><span>無</span></label>
                                    <label><input type="radio" value="3" id="infor_record_book3" name="infor_record_book" tabindex="" accesskey=""><span>未確認</span></label></p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <p class="radio">
                                    <label><input type="radio" value="1" id="infor_history1" name="infor_history" tabindex="" accesskey="" checked><span>自家用</span></label>
                                    <label><input type="radio" value="2" id="infor_history2" name="infor_history" tabindex="" accesskey=""><span>事業用</span></label>
                                    <label><input type="radio" value="3" id="infor_history3" name="infor_history" tabindex="" accesskey=""><span>レンタル</span></label>
                                    <label><input type="radio" value="4" id="infor_history4" name="infor_history" tabindex="" accesskey=""><span>未確認</span></label>
                                </p>
                            </td>
                        </tr>
                        <tr>
                                ...
                                @for($i=0;$i<count($list_equipment);$i++)
                                    @if($i == 0)
                                        <p class="radio">
                                            @endif
                                            <label>
                                                <input type="radio" name="equipment_infor" id="infor_equipment{{$i}}" class="equipment_infor" data-id="{{$list_equipment[$i]->id}}" <?php if ($i==0) echo "checked"?>/>
                                                {{$list_equipment[$i]->name}}</label>
                                            @if(($i+1)%3 == 0)
                                        </p>
                                    @endif
                                    @if(($i+1)%3 == 0 && ($i+1) != count($list_equipment))
                                        <p class="radio"></p>
                                    @endif
                                @endfor
                                {{--<p class="radio">--}}
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="radio">
                                    <label><input type="radio" value="1" id="infor_air_condition1" name="infor_air_condition" tabindex="" accesskey="" checked><span>無</span></label>
                                    <label><input type="radio" value="2" id="infor_air_condition2" name="infor_air_condition" tabindex="" accesskey=""><span>オート</span></label>
                                    <label><input type="radio" value="3" id="infor_air_condition3" name="infor_air_condition" tabindex="" accesskey=""><span>マニュアル</span></label>
                                    <label><input type="radio" value="4" id="infor_air_condition4" name="infor_air_condition" tabindex="" accesskey=""><span>故障</span></label>
                                    <label><input type="radio" value="5" id="infor_air_condition5" name="infor_air_condition" tabindex="" accesskey=""><span>不明</span></label>
                                </p>
                            </td>
                        </tr>
                        <tr>
                            <th class="pos"><span class="hinsu">必須</span> <span class="txtspan">装備品（オプション等）備考</span></th>
                            <td class="vertitop"><input  type="text" value="" name="equipment_infor_remark" id="equipment_infor_remark" size="" tabindex="" accesskey="" placeholder="" maxlength="50"></td>
                        </tr>
                        <tr>
                            <th class="pos"><span class="hinsu">必須</span> <span class="txtspan">外装の状態（キズやヘコミ、塗装はげ、錆など）</span></th>
                            <td class="vertitop"><input  type="text" value="" name="infor_condition_exterior" id="infor_condition_exterior" size="" tabindex="" accesskey="" placeholder=""></td>
                        </tr>
                        <tr>
                            <th class="pos"><span class="hinsu">必須</span> <span class="txtspan">内装の状態（シミやシート破れ、エアコン、オーディオ故障など）</span></th>
                            <td class="vertitop"><input  type="text" value="" name="infor_state_interior" id="infor_state_interior" size="" tabindex="" accesskey="" placeholder=""></td>
                        </tr>
                        <tr>
                            <th class="vertitop"><span class="hinsu">必須</span> 評価点</th>
                            <td>
                                <ul class="flexrowbetween">
                                    <li>総合<input  type="text" value="" name="assessment_synthetic" id="assessment_synthetic" size="" tabindex="" accesskey="" placeholder="">点</li>
                                    <li>外装<input  type="text" value="" name="assessment_exterior" id="assessment_exterior" size="" tabindex="" accesskey="" placeholder="">点</li>
                                    <li>内装<input  type="text" value="" name="assessment_interior" id="assessment_interior" size="" tabindex="" accesskey="" placeholder="">点</li>
                                </ul>
                            </td>
                        </tr>
                        <tr>
                            <th><span class="hinsu">必須</span> 評価者コメント</th>
                            <td><input  type="text" value="" name="assessment_comment" id="assessment_comment" size="" tabindex="" accesskey="" placeholder=""></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <ul class="flexrowbetween">
                                    <li class="flexrowbetween posi w48">
                                        <input  style="display: block" type="file" id="camera17" data_name="pre17" name="evaluation_image" class="evaluation_image" accept="image/*" capture="camera" />
                ...
                <div class="boxstep boxstep5">
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <input  type="text" value="" name="reception_minimum_recommend_price" id="reception_minimum_recommend_price" size="" tabindex="" accesskey="" placeholder="" class="w60per"> 円
                            </td>
                        </tr>
                        <tr>
                            <?php
        ...
        {{--<a  href="" id="submit2" class="btnbtom submit2" >登録する</a>--}}
    </section>
    @endsection
    @section('script')
