    ...
    <article class="assessor estimate">
            ...
            <div class="txt">
                ...
                @if(session()->has('makers')) 
                    @foreach($list_makers as $makers)
                        @if($makers->id == session()->get('makers'))
                            {{ $makers->name }}
                        @endif
                    @endforeach
                @endif
            ...
            <div class="txt">
                ...
                @if(session()->has('cars')) 
                    @foreach($list_cars as $cars)
                        @if($cars->id == session()->get('cars'))
                            {{ $cars->name }}
                        @endif
                    @endforeach
                @endif
                </p>
                <p>走行距離：@if(session()->has('mileage')) {{ session()->get('mileage') }} @endif km/</p>
                <p>車検：平成30年3月17日</p>
            </div>
        </div>
        <div class="boxtxtinfo text_center">
            <h5 class="text_bold">お客様の愛車の想定価格は・・・</h5>
            <h6 class="price text_bold txt_red"></h6>
       ...
       {{--  <div class="boxalert">
        ...
        <div class="clearfix boxboder mt6per">
            <div class="clearfix">
                <div class="pull_left w48">
                    ...
                    <p class="text_center w96"><a href="#a"><button type="button" id="button-red" style="padding:0; border: none; cursor: pointer;"><img src="{{ url('images/estimate/btn1a.png') }}" alt="登録代行サービスを利用して申し込む"></button></a></p>

                </div>
                <div class="pull_right w48">
                    <h4 class="text_center"><img src="{{ url('images/estimate/txtbtn2.png') }}" alt="簡単登録！！　5STEPで直ぐにオークション開始"></h4>
                    <p class="text_center w96"><a href="#b"><button type="button" id="button-blue" style="padding:0; border: none; cursor: pointer;"><img src="{{ url('images/estimate/btn2a.png') }}" alt="ご自身で車両情報を登録して申し込む"></button></a></p>
                </div>
            </div>
        ...
        <form id="RegisterEstimateAssessor" method="post" style="display: none">
         ...
         {{ csrf_field() }}
        <div class="boxstep boxstep1 mt8per" id="a">
        ...
        <div class="boxstep boxstep3">
            ...
            <table class="tbstep1 tbsteptime">
                ...
                <tr>
                    ...
                    <td>
                        <p class="radio"><label><input type="radio" value="1" id="" name="time1" tabindex="" accesskey=""><span>指定なし</span></label>
                        <label><input type="radio" value="2" class="time1" name="time1"><span>9:00～12:00</span></label>
                        <label><input type="radio" value="3" class="time1" name="time1"><span>12:00～15:00</span></label>
                        <label><input type="radio" value="4" class="time1" name="time1"><span>15:00～18:00</span></label>
                        </p>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <th class="text_right vertitop">[時間帯]</th>
                    <td>
                        <p class="radio"><label><input type="radio" value="1" id="" name="time2" tabindex="" accesskey=""><span>指定なし</span></label>
                        <label><input type="radio" value="2" class="time2" tabindex="" accesskey="" name="time2"><span>9:00～12:00</span></label>
                        <label><input type="radio" value="3" class="time2" tabindex="" accesskey="" name="time2"><span>12:00～15:00</span></label>
                        <label><input type="radio" value="4" class="time2" tabindex="" accesskey="" name="time2"><span>15:00～18:00</span></label>
                        </p>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <th class="text_right vertitop">[時間帯]</th>
                    <td>
                        <p class="radio"><label><input type="radio" value="1" id="" name="time3" tabindex="" accesskey=""><span>指定なし</span></label>
                        <label><input type="radio" value="2" class="time3" tabindex="" accesskey="" name="time3"><span>9:00～12:00</span></label>
                        <label><input type="radio" value="3" class="time3" tabindex="" accesskey="" name="time3"><span>12:00～15:00</span></label>
                        <label><input type="radio" value="4" class="time3" tabindex="" accesskey="" name="time3"><span>15:00～18:00</span></label>
                        </p>
                    </td>
                </tr>
            </table>
        ...
        <!-- Hiển thị khi chiếc xe tương ứng không tồn tại -->
        <form id="RegisterEstimate" style="display: none" enctype= "multipart/form-data">
            <meta name="csrf-token" content="{{ csrf_token() }}">
         {{ csrf_field() }}
        <div class="boxstep boxstep1 mt8per" id="b">
            <div class="titline1">
                <h3 class="fontyu"><span class="text_bold colop">STEP1</span> お車を置かれている場所を登録する</h3>
            </div>
            <p class="mb20">郵便番号または都道府県・市町村を登録して下さい</p>
        ...
        <div class="boxstep">
            ...
            <table class="tbstep2">
                <tr>
                    ...
                    <td>
                        <p class="flexrowbetween">
                            <input type="file" id="camera" accept="image/*" capture="camera" class="a" data_name="pre1" name="camera" style="display: block"/>
                ...
                <tr>
                    ...
                    <td>
                        <p class="flexrowbetween">
                            <input type="file" id="camera1" accept="image/*" capture="camera" class="a" data_name="pre2" name="camera1" style="display: block"/>
                ...
                <tr>
                    ...
                    <td>
                        <p class="flexrowbetween">
                            <input type="file" id="camera2" accept="image/*" capture="camera" class="a" data_name="pre3" name="camera2" style="display: block"/>
                ...
                <tr>
                    ...
                    <td>
                        <p class="flexrowbetween">
                            <input type="file" id="camera3" accept="image/*" capture="camera" class="a" data_name="pre4" name="camera3" style="display: block"/>
                ...
                <tr>
                    ...
                    <td>
                        <p class="flexrowbetween">
                            <input type="file" id="camera4" accept="image/*" capture="camera" class="a" data_name="pre5" name="camera4" style="display: block"/>
                ...
                <tr>
                    ...
                    <td>
                        <p class="flexrowbetween">
                            <input type="file" id="camera5" accept="image/*" capture="camera" class="a" data_name="pre6" name="camera5" style="display: block"/>
                ...
                <tr>
                    ...
                    <td>
                        <p class="flexrowbetween">
                            <input type="file" id="camera6" accept="image/*" capture="camera" class="a" data_name="pre7" name="camera6" style="display: block"/>
                ...
                <tr>
                    ...
                    <td>
                        <p class="flexrowbetween">
                            <input type="file" id="camera7" accept="image/*" capture="camera" class="a" data_name="pre8" name="camera7" style="display: block"/>
        ...
        <div class="boxstep">
            ...
            <table class="tbstep2">
                <tr>
                    ...
                    <td>
                        <p class="flexrowbetween">
                            <input type="file" id="camera16" accept="image/*" capture="camera" name="license_drive" class="a" data_name="pre17" style="display: block"/>
